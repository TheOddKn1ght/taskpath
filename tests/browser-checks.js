import { network, localState, activate, lock, clearMemory, isUnlocked, readBoard, offlineRequest, sync, syncAfterCurrent, restoreRemembered, switchAccount } from '/assets/accounts-v10/offline.js';
import { openDatabase, commit, rememberedKey } from '/assets/accounts-v10/persistence.js';
import { unlockVault } from '/assets/accounts-v10/crypto.js';
import { selectAccount } from '/assets/accounts-v10/persistence.js';
...
try {
  ...
  disconnected = true;
  await offlineRequest('/api/tasks', 'POST', { title: 'LOCKED_WORKER_PRIVATE' });
