...
import { sync } from '/assets/accounts-v17/offline.js';
const CACHE = 'taskpath-shell-accounts-v17';
const ROOT = '/assets/accounts-v17/';
const FILES = ['file-format.js', 'file-crypto.js', 'file-persistence.js', 'file-sync.js', 'file-client.js', 'files-ui.js', 'pickers.js', 'picker-model.js', 'dom.js', 'errors.js', 'style.css', 'app.js', 'dates.js', 'navigation.js', 'theme.js', 'vault-ui.js', 'crypto.js', 'persistence.js', 'markdown.js', 'vendor/marked.js',
